...
public interface Clock
{
    ...
    public final class Hour implements Clock {
        ...
        @Override
        public int tick() { return this.hour += 1; }


        @Override
        public void reset() { this.hour = 0; }


        @Override
        public int read() { return this.hour;  }
    ...
    public final class Minute implements Clock {
        ...
        @Override
        public int tick() { return this.minute += 1; }


        @Override
        public void reset() { this.minute = 0; }


        @Override
        public int read() { return this.minute; }
    ...
    public final class Second implements Clock {
        ...
        public Second(int second) { this.second = second; }
        private int second;


        @Override
        public int tick() { return this.second += 1; }


        @Override
        public void reset() { this.second = 0; }


        @Override
        public int read() { return this.second; }
    ...
    public final class Delay  {
      ...
      public Delay(int delay) { this.delay = delay; }
