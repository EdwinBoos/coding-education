...
public class Pool extends HashMap < String, DanielDumile > {
 ...
 public Pool jumpIntoPool(String key, DanielDumile object) {
 ...
 private boolean isInPool(String key) {
...
public class MFDOOM extends DanielDumile {
 ...
 public void spitSomeFire() {
  System.out.println("MF-DOOM - Doomsday");
 } // Polymorphy
...
public class DanielDumileNullObject extends DanielDumile {
 ...
 public DanielDumileNullObject() {
  super();
 }
 public void spitSomeFire() {
  System.out.println("SORRY, NOTHING FOUND!");
 } // Polymorphy, as well ._.
...
public class MadVillain extends DanielDumile {
 ...
 public void spitSomeFire() {
  System.out.println("MadVillain - ALL CAPS");
 } // Polymorphy, as well, as well ._.
